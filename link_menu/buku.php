...
<html lang="en">
  ...
  <div class="container">
    ...
    <br>
    <h1>Data Buku</h1>
    <p>Daftar Buku Perpustakaan WIDYA PRATAMA</p>
    <div><a href="../link_tambah/data_buku.php"><button type="button" class="btn btn-primary">Tambah</button></a></div>
    </br>
    <table class="table text-center">
      ...
      <tbody>
        <?php
        $nomor = 1;
        $statemen = mysqli_query($koneksi, "SELECT * FROM buku");
          ...
          <tr>
            ...
            <td>
              <div class="text-center">
                <a href="../update/buku.php?kode_buku=<?php echo $data['kode_buku']; ?>"><button type="button" class="btn btn-primary">Edit</button></a>
                <a href="../hapus/buku.php?kode_buku=<?php echo $data['kode_buku']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
              </div>
            </td>
          </tr>
        <?php $nomor++;
